...
@Composable
fun  FloodReports (sharedViewModel: SharedViewModel) {
    Row (
    ...
    if (sharedViewModel.reportsListState.none { it.reportType == "Flood" }) {
        Box(
        ...
        Card(
            ...
            sharedViewModel.reportsListState.filter { it.reportType == "Flood" }
                .forEach { floodReport -> FloodReportListItem(floodReport) }
        }
    } //else
} //fun FloodReports

@Composable
fun FloodReportListItem (report : ReportData) {
